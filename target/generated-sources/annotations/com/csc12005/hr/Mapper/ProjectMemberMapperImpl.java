...
public class ProjectMemberMapperImpl implements ProjectMemberMapper {
    ...
    @Override
    public ProjectMember toProjectMember(ProjectMemberCreationRequest projectMemberCreationRequest) {
        if ( projectMemberCreationRequest == null ) {
            return null;
        }

        ProjectMember.ProjectMemberBuilder projectMember = ProjectMember.builder();

        projectMember.role( projectMemberCreationRequest.getRole() );
        projectMember.joinedDate( projectMemberCreationRequest.getJoinedDate() );

        return projectMember.build();
    }
    ...
    public ProjectMemberResponse toProjectMemberResponse(ProjectMember projectMember) {
        ...
        projectMemberResponse.id( projectMember.getId() );
        projectMemberResponse.role( projectMember.getRole() );
        projectMemberResponse.joinedDate( projectMember.getJoinedDate() );
        projectMemberResponse.leftDate( projectMember.getLeftDate() );
        projectMemberResponse.employee( employeeToEmployeeResponse( projectMember.getEmployee() ) );
        projectMemberResponse.project( projectToProjectResponse( projectMember.getProject() ) );
